...
*/
    ...
    */
    ...
    always@(*)begin
        ...
        end else if(/*Command[2] == `READ*/Burst_counter != 0)begin//Data_out_enable, Command[1] == `READ
            case(Bank_temp)
                2'b00:begin
                    bwen = 4'b0000;
                    bren = 4'b0001;
        ...
        */
        if(!Rst_n)begin
            ...
            if(Read_enable)begin//Command[2] == `READ
                ...
                if (Burst_counter == 0) Bank_temp <= Bank_addr[0];
                Bank_temp_buf <= Bank_temp;
            end
        end
    end
...
//                 /*
                ...
                Col[1:0] = Col_temp[1:0];       // Burst Length = 4
